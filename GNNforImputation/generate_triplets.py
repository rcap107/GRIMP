...
def prepare_triplets(df_orig: pd.DataFrame, df_dirty:  pd.DataFrame, valid_fraction=0.2):
    ...
    train_triplets = random.choices(train_valid_triplets, k=int((1-valid_fraction)*len(train_valid_triplets)))
...
if __name__ == '__main__':
    ...
    df_dirty = pd.read_csv('data/main-exp-batch/new_datasets_dirty/mammogram_all_columns_20.csv')
