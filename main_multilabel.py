...
def parse_args():
    ...
    parser.add_argument(
        "--k_strat", action="store", choices=["full", "single", "weak"], default="weak"
    )
    ...
    parser.add_argument(
        "--fd_strategy",
        action="store",
        choices=["val2val", "col2col", "v2vc2c", "attention"],
        default="attention",
    ...
    parser.add_argument(
        "--save_model_file_path", action="store", default=None, type=str
    )
    parser.add_argument(
        "--load_model_file_path", action="store", default=None, type=str
    )
